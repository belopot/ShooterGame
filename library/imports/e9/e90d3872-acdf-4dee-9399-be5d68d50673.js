...
cc.Class({
    ...
    runIcons: function runIcons() {
        this.overlayIcon.runAction(cc.repeatForever(cc.sequence(cc.scaleTo(0.25, 1.2), cc.rotateTo(0.2, -36), cc.rotateTo(0.2, 34), cc.rotateTo(0.2, -30), cc.rotateTo(0.1, 0), cc.scaleTo(0.2, 1), cc.delayTime(2))));

        this.sliderIcon.x = -this.sliderIcon.parent.width / 3;
        this.sliderIcon.runAction(cc.repeatForever(cc.sequence(cc.moveBy(0.8, 2 * this.sliderIcon.parent.width / 3, 0), cc.moveBy(0.8, -2 * this.sliderIcon.parent.width / 3, 0))));
    },
